...
@section('entity-label', 'Embalagem')
@section('entity-url', 'package')
  ...
  <div class="col-md-12">
    ...
    <section class="tile" id="grid">
      ...
      <div class="tile-header dvd dvd-btm">
        <h1 class="custom-font"><strong>Listar</strong> Embalagens</h1>
      </div>
      <!-- /tile header -->
      <div class="tile-widget">
        <div class="row">
          ...
          <div class="col-sm-4">
            <form class="form-inline" method="post" action="{{ url('/package') }}">
...
new Vue({
  ...
  methods: {
    remove: function(){
      ...
      if(result){
        $.ajax({
          url: `{{ url('/package') }}/${this.selected.id}`,
