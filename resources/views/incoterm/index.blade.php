...
@section('entity-label', 'Incoterm')
@section('entity-url', 'incoterm')
  ...
  <div class="col-md-12">
    ...
    <section class="tile" id="grid">
      ...
      <div class="tile-header dvd dvd-btm">
        <h1 class="custom-font"><strong>Listar</strong> Incoterms</h1>
      </div>
      <!-- /tile header -->
      <div class="tile-widget">
        <div class="row">
          ...
          <div class="col-sm-5">
            <form class="form-inline" method="post" action="{{ url('/incoterm') }}">
...
new Vue({
  ...
  methods: {
    remove: function(){
      ...
      if(result){
        $.ajax({
          url: `{{ url('/incoterm') }}/${this.selected.id}`,
