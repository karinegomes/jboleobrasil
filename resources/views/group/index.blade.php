...
@section('entity-label', 'Tipos de Cliente')
@section('entity-url', 'group')
  ...
  <div class="col-md-12">
    ...
    <section class="tile" id="grid">
      ...
      <div class="tile-header dvd dvd-btm">
        <h1 class="custom-font"><strong>Listar</strong> Tipos de Cliente</h1>
      </div>
      <!-- /tile header -->
...
new Vue({
  ...
  methods: {
    remove: function(){
      ...
      if(result){
        $.ajax({
          url: `{{ url('/group') }}/${this.selected.id}`,
