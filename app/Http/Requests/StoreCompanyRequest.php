...
class StoreCompanyRequest extends Request {
    ...
    public function rules() {
        ...
        return [
            'company.codigo' => 'required|max:4|unique:companies,codigo',
            'company.name' => 'required|max:100',
            'company.nome_fantasia' => 'required|max:100',
            'company.registry' => 'bail|max:25|cnpj|unique:companies,companies.registry',
    ...
    public function messages() {
        return [
            ...
            'address.city_id.required' => 'É necessário selecionar uma cidade para o cliente.',
            'address.zip_code.numeric' => 'Apenas números são permitidos no campo de CEP.',
            'company.cpf.max' => 'O CPF do cliente não pode ultrapassar 14 caracteres.',
            'company.cpf.cpf' => 'CPF inválido.',
